#evalua las fuentes de skin2 perfil https://skin2-latamwin.qa.andes-system.com/my-profile/update


#login skin2 y evalua las fuentes de retiros 
...
TARGET_URL = "https://skin2-latamwin.qa.andes-system.com/my-profile/update"
...
def generate_detailed_withdrawals_report(items, filename="profile_detailed_report.html"):
    now = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    html = f"""<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="utf-8">
  <title>Reporte Detallado de Fuentes en profile</title>
  <style>
...
<body>
  <h1>Reporte Detallado de Fuentes en profile</h1>
