...
def generate_mobile_report(data, filename="withdrawals_mobile_report.html"):
    now = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    html = f"""<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="utf-8">
  <title>Fuentes en Withdrawals (Mobile)</title>
  <style>
...
<body>
  <h1>Reporte de Tipos de Letra en Withdrawals</h1>
