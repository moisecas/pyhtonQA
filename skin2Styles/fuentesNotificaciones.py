#hace login y va a https://skin2-latamwin.qa.andes-system.com/notifications a evaluar las fuentes
...
TARGET_URL = "https://skin2-latamwin.qa.andes-system.com/notifications"
...
def generate_detailed_withdrawals_report(items, filename="notifications_detailed_report.html"):
    now = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    html = f"""<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="utf-8">
  <title>Reporte Detallado de Fuentes en notifications</title>
  <style>
...
<body>
  <h1>Reporte Detallado de Fuentes en notifications</h1>
